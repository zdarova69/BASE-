...
CREATE TABLE `passanger` (
  ...
  `name_passanger` varchar(30) NOT NULL,
  `name_airport` varchar(30) NOT NULL,
  `sity_departure` varchar(30) NOT NULL,
  `sity_arrival` datetime(6) NOT NULL,
  `time_depature` datetime(6) NOT NULL,
  `time_arrival` varchar(30) NOT NULL,
...
-- Dump completed on 2022-11-11 11:37:01
